namespace NotSoSuperMario.GameObjects
{
    ...
    public class NinjaCat : Entity
    {
        ...
        public NinjaCat(ContentManager Content, int gameWidth, int gameHeight, double health, double damage, double velocity, Vector2 scale)
        ...
        protected override void CreateAnimations(ContentManager Content)
        {
            ...
            this.animations.Add(MOVE_ANIMATION_KEY, new Animation(moveAnimation, 20, 4, 5, 313, 206));
