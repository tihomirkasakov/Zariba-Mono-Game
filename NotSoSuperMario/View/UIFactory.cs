namespace NotSoSuperMario.View
{
    ...
    public class UIFactory
    {
        public UIFactory()
        {
            ...
            this.StartButton = this.CreateButton("Controls/StartNormal", "Controls/StartHover", new Vector2((Globals.Graphics.PreferredBackBufferWidth - 300) / 2, 100));
            this.ResumeButton = this.CreateButton("Controls/ResumeNormal", "Controls/ResumeHover", new Vector2((Globals.Graphics.PreferredBackBufferHeight - 300) / 2, 100));
            this.FullscreenButton = this.CreateButton("Controls/FullscreenNormal", "Controls/FullscreenHover", new Vector2((Globals.Graphics.PreferredBackBufferWidth - 300) / 2, 200));
            this.Checkbox = this.CreateButton("Controls/CheckboxNormal", "Controls/CheckboxTick", new Vector2((Globals.Graphics.PreferredBackBufferWidth + 350) / 2, 220));
            this.BackButton = this.CreateButton("Controls/BackNormal", "Controls/BackHover", new Vector2((Globals.Graphics.PreferredBackBufferWidth - 300) / 2, 450));
            this.ExitButton = this.CreateButton("Controls/ExitNormal", "Controls/ExitHover", new Vector2((Globals.Graphics.PreferredBackBufferWidth - 300) / 2, 450));
            this.ExitToMenuButton = this.CreateButton("Controls/ExitToMenuNormal", "Controls/ExitToMenuHover", new Vector2((Globals.Graphics.PreferredBackBufferHeight - 300) / 2, 450));
            this.ExitFromGame = this.CreateButton("Controls/ExitFromGameNormal", "Controls/ExitFromGameHover", new Vector2((Globals.Graphics.PreferredBackBufferHeight - 300) / 2, 550));
        }
